...
public class RecActivity extends AppCompatActivity implements myRec.OnFragmentInteractionListener,Recs.OnFragmentInteractionListener{
    ...
    public void initView() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(RecActivity.this,NewReclamation.class);
                startActivity(i);
            }
        });
    ...
    public void initViewPager() {
        ...
        fragments.add(new myRec());
        fragments.add(new Recs());
